...
def dotplot(labelled_groups,
    ...
    for i in range(len(groups)):
        if colours == [] and markers == []:
            ...
            ax2.scatter(info_dict["xs"][i], groups[i][1], edgecolors = "black", marker = markers[i])
        elif colours != [] and markers != []:
            ax2.scatter(info_dict["xs"][i], groups[i][1], edgecolors = "black", color = colours[i], marker = markers[i])
